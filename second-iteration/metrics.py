...
model.load_state_dict(torch.load("checkpoints/cifar-10-linear/model_checkpoint_epoch_201.pth", map_location=device, weights_only=True))
model.eval()
...
num_samples = 10  # Total number of images to generate
